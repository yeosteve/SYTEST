...
(function( $ )
{
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        init : function( element, options )
        {
            ...
            {
                this.appendMenu('createLink', [], null, function( self ) { var szURL = prompt('URL?', 'http://'); if ( szURL && szURL.length > 0 ) self.editorDoc.execCommand('createLink', false, szURL); });
                this.appendMenu('insertImage', [], null, function( self ) { var szURL = prompt('What is the URL', 'http://'); if ( szURL && szURL.length > 0 ) self.editorDoc.execCommand('insertImage', false, szURL); });
            }
